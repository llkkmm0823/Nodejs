...
// 요청의 본문을 해석 및 구분하는 모듈-구버젼 모듈이라 사용하지 않겠습니다.
// const bodyParser = require('body-parser');
//------------------------------------------------------------

const app = express();
app.set('port', process.env.PORT || 3000);  //  서버내에서 사용할 전역변수
...
app.post('/login', (req, res)=>{
    ...
    // express 쿠키 입력에는 Location이 없기때문에 쿠키를 심고 이동할 경로를 별도로 지정해줍니다
    res.redirect('/'); 
});
